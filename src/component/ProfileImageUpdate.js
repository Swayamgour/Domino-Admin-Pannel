...
const ProfileImageUpdate = () => {
    ...
    const handleSaveImage = () => {
        if (imagePreview) {
            ...
            setUserData({ ...userData, profileImage: imagePreview });
                ...
                <div className='relative z-10 text-center'>
                    <div className="mx-auto bg-white/20 backdrop-blur-sm border-2 border-white/30 rounded-full w-32 h-32 flex items-center justify-center mb-4 relative">
                        ...
                        <div className="bg-indigo-100 border-2 border-dashed border-indigo-300 rounded-full w-24 h-24 flex items-center justify-center overflow-hidden">
                            <img
                                src={userData.profileImage || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png'}
                                alt="Profile"
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-800 mb-2">Update Profile Picture</h3>
                            <p className="text-gray-600 mb-6">Upload a new image or remove the current one</p>

                            <div className="flex justify-center mb-6">
                                <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-indigo-100">
                                    <img
                                        src={imagePreview || userData.profileImage || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png'}
                                        alt="Preview"
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <button
                                    ...
                                    className={`${!userData.profileImage ? 'bg-gray-300 cursor-not-allowed' : 'bg-red-100 hover:bg-red-200 text-red-700'} font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center`}
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="bg-gray-100 px-6 py-4 flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className={`${!imagePreview ? 'bg-indigo-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700'} text-white px-5 py-2 rounded-lg font-medium transition-colors`}
                            >
                                Save Changes
                            </button>
                        </div>
